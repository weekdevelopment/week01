...
INSERT INTO MEMBER(id, pw, NAME, email, tel) VALUES 
('kim', '4321', '김영훈', 'kim@edu.com', '010-7979-2848');
INSERT INTO MEMBER(id, pw, NAME, email, tel) VALUES 
('lee', '1111', '이주연', 'lee@edu.com', '010-2424-2424');
INSERT INTO MEMBER(id, pw, NAME, email, tel) VALUES `week`
('park', '7979', '박정우', 'park@edu.com', '010-2848-7979');
INSERT INTO MEMBER(id, pw, NAME, email, tel) VALUES 
('so', '2222', '소정환', 'so@edu.com', '010-2222-1234');
INSERT INTO MEMBER(id, pw, NAME, email, tel) VALUES 
('yoon', '3333', '윤도운', 'yoon@edu.com', '010-3333-3333');
...
-- 인재채용 더미 데이터 삽입
INSERT INTO weekcrew(name, email, content, content2) VALUES ('김지원','kimji@edun.com','끊임없이 도전하며 회사의 성장에 기여하고 싶습니다. 도전은 변화와 혁신을 이끌고, 회사와 저의 성장으로 이어지기 때문입니다. 이에 가장 부합하는 회사가 ‘WEEK’라고 판단하여 지원했습니다.','끊임없이 도전하며 회사의 성장에 기여하고 싶습니다. 도전은 변화와 혁신을 이끌고, 회사와 저의 성장으로 이어지기 때문입니다. 이에 가장 부합하는 회사가 ‘WEEK’라고 판단하여 지원했습니다.');
INSERT INTO weekcrew(name, email, content, content2) VALUES ('이지원','leeji@edun.com','제가 회사를 선택하는 기준은 끊임없이 혁신하고 가치창조를 하며 성장 가능성이 있는 기업인가? 입니다. 4차 산업혁명 시대를 맞이하여 기업이 현재 성과에 안주하고 혁신을 멈춘다면 자연스럽게 도태될 것입니다. WEEK과 함께 성장하고 싶습니다.','제가 회사를 선택하는 기준은 끊임없이 혁신하고 가치창조를 하며 성장 가능성이 있는 기업인가? 입니다. 4차 산업혁명 시대를 맞이하여 기업이 현재 성과에 안주하고 혁신을 멈춘다면 자연스럽게 도태될 것입니다. WEEK과 함께 성장하고 싶습니다.');
INSERT INTO weekcrew(name, email, content, content2) VALUES ('강지원','kangji@edun.com','기업을 선택할 때 상호 존중 하에 본인의 역량을 얼마나 발휘할 수 있는가?에 대해 항상 고민합니다. 그 이유는 기업의 임직원 분들이 상호 존중의 정도에 따라서 역량을 발휘할 수 있는 것은 천지 차이이기 때문입니다. 만약 서로가 존중하지 않고 소통이 결여된 곳이라면 본인의 역량을 제한적으로 발휘할 것이고 서로의 눈치를 보며 그 기업은 더 나아가 발전할 수 없을 것입니다. WEEK에서 더욱 성장하고 싶습니다.','기업을 선택할 때 상호 존중 하에 본인의 역량을 얼마나 발휘할 수 있는가?에 대해 항상 고민합니다. 그 이유는 기업의 임직원 분들이 상호 존중의 정도에 따라서 역량을 발휘할 수 있는 것은 천지 차이이기 때문입니다. 만약 서로가 존중하지 않고 소통이 결여된 곳이라면 본인의 역량을 제한적으로 발휘할 것이고 서로의 눈치를 보며 그 기업은 더 나아가 발전할 수 없을 것입니다. WEEK에서 더욱 성장하고 싶습니다.');
INSERT INTO weekcrew(name, email, content, content2) VALUES ('최지원','choiji@edun.com','WEEK에 입사하여 더욱 깨끗하고 올바른 조직문화를 만들어 임직원 분들이 일하기 좋은 환경을 만들고 회사에 기여하고 싶기 때문입니다. 저는 회사를 지원할 때 선택하는 기준으로 역량을 십분 발휘할 수 있고 저를 통해 회사가 더욱 성장하고 발전할 수 있는지를 고려합니다. WEEK의 인사 직무는 타 부서를 위한 또 다른 고객센터라고 생각합니다. ','WEEK에 입사하여 더욱 깨끗하고 올바른 조직문화를 만들어 임직원 분들이 일하기 좋은 환경을 만들고 회사에 기여하고 싶기 때문입니다. 저는 회사를 지원할 때 선택하는 기준으로 역량을 십분 발휘할 수 있고 저를 통해 회사가 더욱 성장하고 발전할 수 있는지를 고려합니다. WEEK의 인사 직무는 타 부서를 위한 또 다른 고객센터라고 생각합니다. ');
